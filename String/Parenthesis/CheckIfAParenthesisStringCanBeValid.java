    ...
    public boolean canBeValid(String s, String locked) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (ch == '(' || locked.charAt(i) == '0') {
                // If it's unlocked, we can treat it as an opening bracket
                balance++;
            } else if (ch == ')') {
            ...
            // If balance becomes negative, it means we have more closing brackets than opening
            if (balance < 0) {
                return false;
            }
        }
        ...
        for (int i = n - 1; i >= 0; i--) {
            char ch = s.charAt(i);
            if (ch == ')' || locked.charAt(i) == '0') {
                // If it's unlocked, we can treat it as a closing bracket
                balance++;
            } else if (ch == '(') {
                // If it's an opening bracket, decrease balance
                balance--;
            }
            
            // If balance becomes negative, it means we have more opening brackets than closing
            if (balance < 0) {
                return false;
            }
        }
